			...
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<s:if test="#request.serverList.size>0">
							<s:iterator value="#request.serverList">
								<tr>
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">
											<a href='<%=path%>/server!show?serverId=<s:property value="id" />'>
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">
											<a href='<%=path%>/server!delete?serverId=<s:property value="id" />'><img
