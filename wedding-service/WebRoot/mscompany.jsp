...
<html>
	...
	<body style="margin-top: 0px; margin-left: 0px; margin-right: 0px;">
		<form action="company!add" method="post" name="addForm">
											...
											<td>
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td valign="middle">
															<span style="color: white; font-size: 12px;">添加公司</span>
														</td>
													</tr>
												</table>
											</td>
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								<td width="25%" bgcolor="#ffffff"></td>
								<td height="60" bgcolor="d3eaef" class="STYLE6" width="25%" valign="top">
									<div align="center">
