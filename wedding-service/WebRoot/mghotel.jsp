			...
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<s:if test="#request.hotelList.size>0">
							<s:iterator value="#request.hotelList">
								<tr>
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">
											<a href='<%=path%>/hotel!show?hotelId=<s:property value="id" />'>
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">
											<a href='<%=path%>/hotel!delete?hotelId=<s:property value="id" />'><img
